        ...
        <form action="confirmation.php" method="POST" id="checkoutForm">
            ...
            <div class="section">
                ...
                <div id="ewallet-details" class="payment-details" style="display:none;">
                    ...
                    <input type="text" name="ewallet_account" placeholder="E-Wallet Account/Phone" required>
                </div>
                <div id="bank-details" class="payment-details" style="display:none;">
                    <label>Bank Transfer Reference</label>
                    <input type="text" name="bank_reference" placeholder="Bank Transfer Reference Number" required>
                </div>
            </div>
            ...
            <div class="section order-summary">
                ...
                <?php foreach ($cartItems as $item): ?>
                    <p><?= htmlspecialchars($item['name']) ?> × <?= $item['Quantity'] ?> - RM <?= number_format($item['TotalPrice'], 2) ?></p>
                <?php endforeach; ?>
        ...
        document.getElementById('checkoutForm').addEventListener('submit', function(e) {
            ...
            if (paymentMethod === 'Credit/Debit Card') {
                ...
                if (!ewalletAccount.value.trim()) {
                    e.preventDefault();
                    alert('Please enter e-wallet account');
